...
orig_fname = '/Users/tim/Documents/felix_quartets_got_annotated/1_op12/C0/1_op12_2_omr.musicxml'
...
parts = [
    ...
    x.getElementsByClass(m21.stream.Part), remove=['+'], interleave=True, just_tokens=True) 
    for x in streams
    ]
...
a, b, align_record, score = nwa.perform_alignment(onepass_tokens, correct_tokens, match_weights, gap_penalties, ignore_case=True)
