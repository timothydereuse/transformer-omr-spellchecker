...
omr_file = (
    r"C:\Users\tim\Documents\datasets\just_quartets\felix_omr\1_op12_4_omr.musicxml"
)
# omr_file = r"C:\Users\tim\Documents\datasets\solo_piano\gstring_snippet2.mxl"
correct_file = r"C:\Users\tim\Documents\datasets\just_quartets\felix_onepass\1_op12_4_corrected.musicxml"
...
def get_reps(m21_stream):
    reps = [
        ...
        [
            x.music_element
            for x in sta.m21_parts_to_interleaved_agnostic(m21_stream, interleave=False)
        ],
    ]
    return reps
...
for i, group in enumerate(groups):
    ...
    correct_align, error_align, r, score = align.perform_alignment(
        correct_vec, omr_vec, match_weights=[2, -2], gap_penalties=[-1, -1, -1, -1]
    )
...
for x in error_rates:
    print(
        "{vocab_size}, {len_correct}, {num_operations}, {error_rate}, {replace_rate}, {delete_rate}, {insert_rate}".format(
            **x
        )
    )
